<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="addPattern.aspx.cs" Inherits="GrandFitManagementSystem.addPattern" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- BEGIN PAGE HEADER-->
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Patterns Page <small>add patterns</small>
					</h3>
    ...
    <form runat="server">
        ...
        <div class="form-group">
			<label class="control-label">New Pattern Name</label>
